        ...
        blocks: [
          {
            ...
            body: [
              { kind: 'heading', text: 'Os 5 Indicadores Fundamentais' },
              {
                kind: 'pillar-grid',
                pillars: [
                  { id: 'pib', label: 'PIB', description: 'Soma de tudo que o país produz. Crescendo = mercado expandindo. Caindo 2 trimestres = recessão técnica → prepare caixa.' },
                  { id: 'ipca', label: 'IPCA', description: 'Taxa de inflação oficial. Alta → BC sobe juros → crédito caro → consumo cai. Acompanhe pelo IBGE mensalmente.' },
                  { id: 'selic', label: 'Selic', description: 'Juros básicos definidos pelo COPOM. Alta = empréstimos caros, priorize caixa. Baixa = crédito barato, invista e expanda.' },
                  { id: 'cambio', label: 'Câmbio', description: 'Real fraco = importações caras, exportações competitivas. Real forte = importações baratas, exportações perdem margem.' },
                  { id: 'desemprego', label: 'Desemprego', description: 'Alto = consumo fraco + mão de obra disponível. Baixo = consumo forte + guerra por talentos e pressão salarial.' },
                ],
              },
              { kind: 'heading', text: 'Política Monetária e Fiscal' },
              {
                kind: 'paragraph',
                ...
                items: [
                  {
                    ...
                    correctFeedback: 'Correto. Quando PIB cresce, Selic é baixa e desemprego cai, a janela de expansão está aberta. Invista, contrate, lance produtos — mas mantenha reserva.',
                  ...
                  },
                  {
                    ...
                    sublabel: 'Empresa tem R$ 400K em dívida pós-fixada (atrelada ao CDI). Vendas começaram a cair.',
                    ...
                    wrongFeedback: 'Repense. Com Selic subindo e dívida pós-fixada, cada ponto percentual aumenta seu custo financeiro. Renegociar agora, antes do pico, é mais barato do que esperar.',
                  },
                  {
                    id: 'cen-recessao',
                    label: 'PIB recua pelo 2º trimestre',
                  ...
                  },
                  {
                    ...
                    correctZone: 'renegociar',
                    correctFeedback: 'Correto. Câmbio desfavorável para importadores exige renegociação: buscar fornecedores nacionais, renegociar contratos em reais ou fazer hedge cambial para travar o custo.',
                    wrongFeedback: 'Repense. Dólar alto destrói margem de quem importa insumos. A prioridade é renegociar a cadeia de suprimentos — fornecedores nacionais ou hedge cambial — antes de expandir.',
                  },
                  {
                    id: 'cen-vale',
                    ...
                    correctZone: 'expandir',
                    correctFeedback: 'Correto. O vale do ciclo é o melhor momento para expandir: ativos estão baratos, crédito vai ficar mais barato, e concorrentes enfraquecidos abrem espaço. Quem age no vale captura a próxima expansão.',
                    wrongFeedback: 'Repense. Quando o BC começa a cortar juros com inflação cedendo, estamos no vale do ciclo — a janela de comprar ativos baratos e se posicionar para a próxima expansão.',
                  },
                ],
              },
            },
            synthesis: {
              closingText: 'Macroeconomia não é para prever o futuro — é para {{não ser pego de surpresa}}. Quem lê os indicadores com antecedência renegocia dívidas no pico, expande no vale e protege caixa na contração. Os outros só percebem quando já é tarde.',
              keyInsights: [
                ...
                'Política monetária e fiscal em conflito = pior cenário. Aprenda a identificar quando as duas políticas estão alinhadas vs. brigando.',
              ],
            },
          },
          {
                ...
                phases: [
                  {
                    id: 'expansao',
                    label: 'Expansão',
                    description: 'PIB crescendo, desemprego caindo, crédito farto, otimismo no mercado.',
                    action: 'Investir, expandir, contratar, lançar produtos. Mas construa reserva — a festa acaba.',
                  },
                  {
                    id: 'pico',
                    label: 'Pico',
                    description: 'Inflação subindo, ativos caros (bolsa, imóveis em alta), euforia generalizada.',
                    action: 'Preparar caixa, reduzir dívida variável, diversificar receita. "Desta vez é diferente" é a frase mais perigosa.',
                  },
                  {
                    id: 'contracao',
                    label: 'Contração',
                    description: 'PIB caindo, demissões, crédito restrito, pessimismo generalizado.',
                    action: 'Proteger caixa, cortar não-essencial, renegociar contratos. Quem tem caixa compra o futuro barato.',
                  },
                  {
                    id: 'vale',
                    label: 'Vale',
                    description: 'PIB estabilizando, inflação cedendo, BC começa a cortar juros.',
                    action: 'Posicionar para a próxima expansão — investir enquanto está barato. Esperar demais perde a janela.',
                  },
                ],
              },
              { kind: 'heading', text: 'Indicadores que Antecipam a Mudança de Fase' },
              {
                kind: 'paragraph',
                ...
                items: [
                  {
                    ...
                    wrongFeedback: 'Repense. Bolsa em recorde com euforia generalizada = expansão no auge ou pico. Não é hora de dobrar a aposta — é hora de preparar caixa para a contração que vem.',
                  },
                  {
                    id: 'sit-demissoes',
                    label: 'Demissões em massa no setor',
                    sublabel: 'Grandes empresas do setor cortam 15-20% do quadro. Crédito restrito, consumo retraído.',
                    ...
                    wrongFeedback: 'Repense. Demissões em massa + crédito restrito indicam contração. O paradoxo: é quando você deve cortar não-essencial E ficar de olho em oportunidades de aquisição e contratação.',
                  },
                  {
                    id: 'sit-bc-cortando',
                    label: 'BC anuncia 3º corte da Selic',
                    sublabel: 'Inflação abaixo da meta, PIB voltando a crescer levemente após recessão, crédito voltando.',
                    correctZone: 'vale',
                    correctFeedback: 'Correto. BC cortando juros com inflação cedendo = saída do vale. A janela de posicionamento para a próxima expansão está aberta — investir agora é comprar no desconto.',
                    wrongFeedback: 'Repense. BC cortando Selic com inflação cedendo = fundo do ciclo (vale). Esse é o melhor momento para investir: ativos ainda baratos, mas crédito ficando mais acessível.',
                  },
                  {
                    id: 'sit-pmi-abaixo',
                    label: 'PMI industrial abaixo de 50 por 3 meses',
                    ...
                    wrongFeedback: 'Repense. PMI abaixo de 50 = atividade industrial contraindo. Sustentado por 3 meses = tendência clara. Estamos na contração — proteja o caixa.',
                  },
                  {
                    id: 'sit-desemprego-minimo',
                    label: 'Desemprego em mínima histórica',
                    sublabel: 'Taxa de desemprego a 5%, empresas relatando dificuldade de contratar, salários subindo.',
                    correctZone: 'expansao',
                    ...
                    wrongFeedback: 'Repense. Desemprego mínimo com pressão salarial = mercado aquecido = expansão. A outra face: custo de pessoal sobe, o que comprime margens antes da desaceleração.',
                  },
                ],
              },
            },
          ...
          },
          {
            ...
            body: [
              { kind: 'heading', text: 'Estrutura do PIB Brasileiro' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: '5 Desafios Estruturais' },
              {
                kind: 'pillar-grid',
                pillars: [
                  { id: 'tributario', label: 'Carga tributária complexa', description: '33% do PIB em impostos + 1.500 horas/ano de compliance (pior do mundo). Reforma Tributária (EC 132/2023) simplifica em 10 anos.' },
                  { id: 'infraestrutura', label: 'Infraestrutura deficiente', description: 'Custo logístico: 12% do PIB vs. 8% nos EUA. Rodovias precárias encarecem tudo. Oportunidade: concessões e PPPs.' },
                  { id: 'desigualdade', label: 'Desigualdade extrema', description: 'Gini 0,52 — 10% mais ricos detêm 59% da renda. Mercado fragmentado: luxo e base da pirâmide crescem, classe média encolhe.' },
                  { id: 'capital', label: 'Custo de capital alto', description: 'Spread bancário ~20pp acima da Selic — um dos maiores do mundo. Empréstimos caros desincentivam investimento produtivo.' },
                  { id: 'burocracia', label: 'Burocracia', description: '120 dias para abrir empresa (vs. 1 dia na Estônia). Regulação incerta afasta investimento de longo prazo.' },
                ],
              },
              { kind: 'heading', text: 'Reforma Tributária — O que Muda' },
              {
                kind: 'paragraph',
                text: '5 tributos (PIS, COFINS, IPI, ICMS, ISS) viram 2 (CBS federal + IBS estadual) formando o IVA. Princípio: não-cumulatividade plena e cobrança no destino (local de consumo). Serviços pagam mais (de ISS de 2-5% para ~26,5%). Indústria paga menos (fim da cascata). Transição: 2026 a 2033.',
              },
            ],
            application: {
              kind: 'compare-and-drag',
                ...
                items: [
                  {
                    ...
                    sublabel: 'Hoje paga ISS de 5% sobre serviços prestados. Quase nenhum insumo tributável para gerar crédito.',
                    ...
                    wrongFeedback: 'Repense. Serviços de consultoria têm poucos insumos tributáveis (créditos). ISS de 5% → IVA ~26,5% sem créditos suficientes = aumento real de carga.',
                  },
                  {
                    ...
                    correctFeedback: 'Correto. Indústria paga menos: a cascata de 30-45% efetivo é substituída por IVA de ~26,5% com crédito pleno sobre todos os insumos. Fim da guerra fiscal entre estados.',
                    wrongFeedback: 'Repense. A indústria sofre hoje com cascata tributária (ICMS + IPI + PIS/COFINS). O IVA com crédito pleno elimina essa cascata — carga efetiva cai para a maioria das indústrias.',
                  },
                  {
                    id: 'ref-exportadora',
                    ...
                    correctZone: 'neutro',
                    correctFeedback: 'Correto. Exportações já são isentas hoje (princípio do destino) e continuarão isentas no novo sistema. Impacto da reforma é neutro para quem exporta — o IVA não incide na saída do país.',
                    wrongFeedback: 'Repense. Exportações são isentas no modelo IVA (princípio do destino: imposto fica no local de consumo). Como o consumo é no exterior, não há IVA. Situação similar à atual.',
                  },
                  {
                    id: 'ref-restaurante',
                    label: 'Rede de restaurantes',
                    sublabel: 'Hoje no Simples Nacional com ISS reduzido. Insumos de alimentos (carne, vegetais) terão alíquota zerada no IVA.',
                    correctZone: 'neutro',
                    correctFeedback: 'Correto. Restaurantes têm situação mista: serviço paga mais, mas insumos alimentares ficam com alíquota zero. Crédito sobre alimentos compensa parte do aumento. Impacto depende do mix de custos.',
                    wrongFeedback: 'Repense. Restaurantes têm dois lados: serviço (paga mais) e insumos alimentares (alíquota zero). O equilíbrio entre os dois tende a impacto neutro para a maioria das operações.',
                  },
                  {
                    id: 'ref-varejista',
                    label: 'Varejista com loja física',
                    sublabel: 'Hoje lida com substituição tributária complexa do ICMS por estado. Muita burocracia de compliance.',
                    correctZone: 'paga-menos',
                    correctFeedback: 'Correto. Varejistas ganham em simplificação: fim da substituição tributária e suas complexidades por estado. Carga pode ser similar, mas custo de compliance cai — o que é ganho real.',
                    wrongFeedback: 'Repense. Para o varejo, o maior ganho não é necessariamente carga menor — é simplificação. Fim da substituição tributária e unificação de regras por estado reduz custo de compliance.',
                  },
                ],
              },
            },
            synthesis: {
              closingText: 'O Brasil exige uma leitura dupla: {{os desafios são reais, mas as oportunidades estão exatamente onde os outros desistem}}. Energia renovável, agro-tech, economia digital e biodiversidade são vantagens competitivas globais que ainda estão sendo exploradas.',
              keyInsights: [
          ...
          },
          {
            ...
            body: [
              { kind: 'heading', text: 'As 5 Transformações do Mercado de Trabalho' },
              {
                kind: 'step-flow',
                steps: [
                  { id: 'escassez', label: 'Escassez de talento qualificado', description: 'Desemprego geral: 6,5%. Desemprego em tech: ~1%. Paradoxo: milhões desempregados, empresas sem candidato. Solução: upskilling interno — mais barato que competir por pronto.' },
                  { id: 'hibrido', label: 'Trabalho híbrido como padrão', description: '38% dos qualificados operam em modelo híbrido. Empresas 100% presenciais perdem candidatos. Dado: híbrido retém 12% mais talentos (McKinsey 2024).' },
                  { id: 'gig', label: 'Gig economy e pejotização', description: '25M trabalhadores informais. Pejotização reduz encargos mas cria risco jurídico se relação é subordinada e contínua. Reforma Trabalhista (2017) criou o intermitente.' },
                  { id: 'diversidade', label: 'Diversidade como resultado', description: 'Empresas com diversidade étnica: 36% mais chance de superar a média (McKinsey). Diversidade de gênero na liderança: 25% mais lucratividade. Não é só ética — é business case.' },
                  { id: 'ia', label: 'IA não substitui empregos — substitui tarefas', description: '30% das tarefas atuais podem ser automatizadas. A pergunta certa: "alguém usando IA vai substituir quem não usa?" — e a resposta é sim.' },
                ],
              },
              { kind: 'heading', text: 'Sistema Financeiro — O que o Gestor Precisa Saber' },
              {
                kind: 'paragraph',
                text: 'BCB define a Selic e opera o PIX (2,4 bilhões de transações/mês). Big 5 bancos (Itaú, Bradesco, BB, Santander, Caixa) concentram 80% dos ativos. Nubank com 100M+ clientes e fintechs forçaram custo zero em contas e transferências. Open Banking permite comparar crédito de múltiplos bancos automaticamente. Regra de caixa: mínimo 3-6 meses de despesas em CDB 100% CDI ou Tesouro Selic — nunca em cheque especial (>300%/ano).',
              },
            ],
            application: {
              kind: 'compare-and-drag',
              compare: {
                ...
                rows: [
                  ...
                  { label: 'Debêntures', values: ['Médio (risco da empresa emissora)', 'Prazo definido (1–5 anos)', 'Diversificação de renda fixa com mais retorno'], viz: 'bars' },
                  { label: 'Cheque especial', values: ['Altíssimo (>300%/ano)', 'Liquidez imediata', 'Nunca — substitua por capital de giro negociado'], viz: 'icons' },
                  { label: 'PIX Cobrança', values: ['Nenhum (Banco Central)', 'Liquidação imediata', 'Substituir boleto — sem custo, sem prazo'], viz: 'icons' },
                ],
              },
              drag: {
                ...
                zones: [
                  ...
                  { id: 'depende', label: 'Depende do contexto' },
                ],
                items: [
                  {
                    id: 'fin-cheque',
                    label: 'Usar cheque especial para cobrir folha de pagamento',
                    sublabel: 'Empresa tem déficit de caixa temporário de R$ 30K. Cheque especial está disponível.',
                    correctZone: 'errado',
                    correctFeedback: 'Correto — é decisão errada. Cheque especial pode custar mais de 300%/ano. Em uma semana, R$ 30K viram uma dívida cara. A alternativa: negociar antecipação de recebíveis com o banco.',
                    wrongFeedback: 'Repense. Cheque especial passa de 300%/ano de juros. Usar para cobrir folha é um dos erros mais caros que um gestor pode cometer. Antecipação de recebíveis, capital de giro ou FGI são alternativas.',
                  },
                  {
                    id: 'fin-cdb',
                    ...
                    correctZone: 'certo',
                    correctFeedback: 'Correto. 3-6 meses de reserva em aplicação de liquidez diária (CDB 100% CDI) é a regra de ouro de gestão de caixa. Protege contra sazonalidade, inadimplência e imprevistos.',
                    wrongFeedback: 'Repense. Manter reserva operacional em CDB com liquidez diária é gestão de caixa básica e correta. 3-6 meses de despesas fixas protege a empresa contra qualquer interrupção de receita.',
                  },
                  {
                    id: 'fin-pejotizacao',
                    label: 'Contratar 5 funcionários de tempo integral como PJ',
                    sublabel: 'Empresa quer reduzir encargos. Funcionários trabalharão exclusivamente para ela, com horário definido.',
                    correctZone: 'errado',
                    correctFeedback: 'Correto — é arriscado e tende a ser errado. Relação subordinada, contínua e exclusiva configura vínculo empregatício mesmo com contrato PJ. Risco de passivo trabalhista alto em caso de fiscalização ou processo.',
                  ...
                  },
                  {
                    ...
                    sublabel: 'Empresa precisa de capital de giro. Gestora compartilha dados financeiros via Open Finance com 3 bancos.',
                    correctZone: 'certo',
                    correctFeedback: 'Correto. Open Banking foi feito exatamente para isso: aumentar poder de negociação do tomador. Comparar ofertas de múltiplos bancos automaticamente reduz spread e melhora condições.',
                    wrongFeedback: 'Repense. Open Banking é uma das melhores ferramentas para o gestor negociar crédito: você compartilha seu histórico financeiro com vários bancos e recebe propostas competitivas. Resultado: juros menores.',
                  },
                  {
                    id: 'fin-debenture',
                    label: 'Investir reserva de caixa em debêntures de 3 anos',
                    sublabel: 'Empresa tem R$ 200K de reserva operacional. Gestor quer mais rentabilidade do que CDB.',
                    correctZone: 'errado',
                    correctFeedback: 'Correto — errado para reserva operacional. Debêntures têm prazo definido e baixa liquidez. Reserva operacional precisa estar disponível imediatamente. Debêntures são para capital excedente, não para o caixa de emergência.',
                    wrongFeedback: 'Repense. Reserva operacional deve ter liquidez imediata. Debêntures com prazo de 3 anos bloqueiam o capital — se surgir uma emergência, você não consegue resgatar sem perda. Use CDB com liquidez diária para a reserva.',
                  },
                ],
              },
            },
        ...
        blocks: [
          {
            ...
            body: [
              { kind: 'heading', text: 'Análise Vertical — A Estrutura' },
              {
                kind: 'paragraph',
                text: 'Compara cada item com um referencial dentro do mesmo período. Na DRE: cada linha como % da Receita Líquida. No Balanço: cada conta como % do Ativo Total. Exemplo: CMV representando 65% da receita quando o setor é 45% — a operação está ineficiente. O problema pode ser preço de compra alto, desperdício ou produto subprecificado.',
              },
              { kind: 'heading', text: 'Análise Horizontal — A Tendência' },
              {
                kind: 'paragraph',
                text: 'Compara o mesmo item ao longo de diferentes períodos. Receita cresceu 15%/ano? Lucro cresceu junto ou foi consumido por despesas? Despesas administrativas subiram 40% enquanto receita cresceu 10%? A estrutura está inchando. A análise horizontal expõe tendências que a vertical nunca mostraria.',
              },
              { kind: 'heading', text: 'Índices Fundamentais de Análise' },
              {
                kind: 'pillar-grid',
                pillars: [
                  { id: 'co', label: 'Ciclo Operacional', description: 'PME + PMR. Quanto tempo entre comprar insumo e receber do cliente. Quanto menor, menos capital imobilizado.' },
                  { id: 'cf', label: 'Ciclo Financeiro', description: 'Ciclo Operacional − PMP. Quanto tempo a empresa financia com capital próprio. Negativo = recebe antes de pagar (ideal: iFood, Mercado Livre).' },
                  { id: 'ga', label: 'Giro do Ativo', description: 'Receita ÷ Ativo Total. Quantas vezes o ativo gira em receita. Varejo: 3–5x. Indústria pesada: 0,5–1x.' },
                  { id: 'mc', label: 'Margem de Contribuição', description: 'Preço − Custos Variáveis. O quanto cada venda contribui para cobrir fixos. MC negativa = vender mais aumenta o prejuízo.' },
                ],
              },
            ],
            application: {
              ...
              compare: {
                ...
                rows: [
                  { label: 'Análise Vertical', values: ['Composição: cada item como % do total', '"Quanto desta linha é custo, margem ou despesa?"', 'CMV > 60% da receita em varejo de margem alta'], viz: 'icons' },
                  { label: 'Análise Horizontal', values: ['Tendência: evolução de um item no tempo', '"Esta conta está crescendo mais do que deveria?"', 'Despesas crescendo 2× mais que a receita'], viz: 'icons' },
                  { label: 'Ciclo Financeiro', values: ['Velocidade: quanto tempo o dinheiro fica preso', '"Preciso de capital de giro ou me autofinancio?"', 'Ciclo > 60 dias com receita estagnada'], viz: 'bars' },
              ...
              drag: {
                ...
                zones: [
                  ...
                  { id: 'ciclo', label: 'Problema de Ciclo / Liquidez' },
                ],
                items: [
                  {
                    id: 'diag-cmv-alto',
                    ...
                    correctFeedback: 'Correto. CMV como % da receita é análise vertical — mostra a estrutura de custos em um dado período. 68% vs. benchmark de 45% = ineficiência operacional. Investigar: preço de compra, desperdício ou precificação baixa.',
                    wrongFeedback: 'Repense. Comparar CMV como % da receita dentro do mesmo período é análise vertical — ela mostra a estrutura, não a tendência. O problema aqui é composição, não evolução temporal.',
                  },
                  {
                    ...
                    wrongFeedback: 'Repense. Quando você compara o crescimento de um item ao longo de diferentes períodos (2 anos), está fazendo análise horizontal. Ela revela tendências que a análise vertical de um único período nunca mostraria.',
                  },
                  {
                    id: 'diag-ciclo-longo',
                    ...
                    wrongFeedback: 'Repense. O sintoma (caixa apertado com boas vendas) é clássico de ciclo financeiro longo. A empresa é lucrativa mas o dinheiro demora muito para circular. Solução: reduzir estoque, antecipar recebíveis ou alongar pagamentos.',
                  },
                  {
                    ...
                    correctZone: 'vertical',
                    correctFeedback: 'Correto. Margem líquida como % da receita é análise vertical — ela mostra a eficiência da operação. Lucro absoluto crescendo mas margem caindo = empresa cresce mas fica menos eficiente. O crescimento está "comendo" a margem.',
                    wrongFeedback: 'Repense. Analisar margem (lucro como % da receita) é análise vertical. O lucro absoluto cresceu (horizontal positivo), mas a estrutura piorou (vertical negativo). A empresa fatura mais mas fica menos eficiente.',
                  },
                  {
                    id: 'diag-giro-baixo',
                    ...
                    correctZone: 'ciclo',
                    correctFeedback: 'Correto. Giro do Ativo de 0,4x vs. benchmark de 1,2x = ativos subutilizados. A empresa imobilizou recursos que não estão gerando receita proporcional. Investigar: ativos ociosos, capacidade mal utilizada ou ativo superavaliado.',
                    wrongFeedback: 'Repense. Giro do Ativo (Receita ÷ Ativo) mede eficiência — o quanto cada real de ativo gera em receita. Abaixo do benchmark do setor indica ativos subutilizados ou superdimensionados.',
                  },
                ],
              },
            },
            synthesis: {
              closingText: 'A análise mais poderosa cruza vertical com horizontal: a vertical mostra {{onde está o problema}} na estrutura, a horizontal mostra {{quando o problema começou}} e se está piorando. Juntas revelam o diagnóstico completo — sem elas, você gerencia no escuro.',
              keyInsights: [
                ...
                phases: [
                  {
                    ...
                    description: 'Projeta fluxos de caixa livres futuros e traz a valor presente usando o WACC. Método mais robusto — mas sensível a premissas.',
                    action: 'Melhor para: empresas com fluxo previsível. Premissa-chave: taxa de crescimento e taxa de desconto. Cuidado: pequenas mudanças nas premissas mudam o resultado dramaticamente.',
                  },
                  {
                    id: 'multiplos',
                    label: 'Múltiplos de Mercado',
                    description: 'Compara com empresas similares usando ratios: EV/EBITDA, P/L, EV/Receita.',
                    action: 'SaaS: 8–15× receita. Varejo: 6–10× EBITDA. Indústria: 4–7× EBITDA. Atenção: múltiplo de mercado americano não vale para PME brasileira — risco país e juros mudam tudo.',
                  },
                  {
                    id: 'patrimonial',
                    label: 'Valor Patrimonial',
                    description: 'Ativo − Passivo. Usado quando a empresa vale mais desmontada do que operando, ou para negócios asset-heavy.',
                    action: 'Não considera capacidade de gerar lucro futuro — é o piso do valuation. Se operação gera valor acima do patrimonial, use DCF ou múltiplos.',
                  },
                ],
              },
              { kind: 'heading', text: 'Para Startups (pré-receita)' },
              {
                kind: 'paragraph',
                text: 'Método Berkus: 5 fatores qualitativos (ideia, protótipo, equipe, mercado, vendas) × até R$ 500K cada. Método VC: parte do retorno esperado e calcula para trás. Método Scorecard: compara com startups similares da região. Na prática, investidores sérios triangulam os 3 métodos — se DCF diz R$ 10M e múltiplos dizem R$ 8M, o valor justo está nessa faixa, com piso patrimonial.',
              },
            ],
            application: {
              kind: 'compare-and-drag',
              ...
              drag: {
                instruction: 'Toque na empresa, depois toque no método de valuation mais adequado para ela:',
                zones: [
                  { id: 'dcf', label: 'DCF' },
                ...
                items: [
                  {
                    ...
                    correctFeedback: 'Correto. SaaS de alto crescimento sem lucro ainda é melhor avaliado por EV/Receita (8–15×). O DCF precisaria de muitas premissas incertas. Múltiplos de mercado capturam melhor o valor de crescimento.',
                    wrongFeedback: 'Repense. SaaS em crescimento sem EBITDA positivo é difícil de avaliar por DCF (muitas premissas incertas) e não tem ativos para método patrimonial. Múltiplos de receita (8–15× para SaaS) são o padrão de mercado.',
                  },
                  {
                    id: 'val-industria',
                    ...
                    correctZone: 'dcf',
                    correctFeedback: 'Correto. Fluxo previsível + empresa madura = DCF é o método mais robusto. A previsibilidade elimina o principal risco do método (premissas incertas). Complementar com múltiplos do setor para triangular.',
                    wrongFeedback: 'Repense. Indústria madura com fluxo de caixa previsível é o caso ideal para DCF — o método funciona melhor quando os fluxos futuros são confiáveis. Premissas realistas + fluxo estável = valuation defensável.',
                  },
                  {
                    id: 'val-imobiliaria',
                    ...
                    correctFeedback: 'Correto. Quando a operação gera prejuízo mas os ativos têm valor, o método patrimonial (Ativo − Passivo) é o mais adequado. A empresa pode valer mais "desmontada" (vendendo os ativos) do que operando.',
                    wrongFeedback: 'Repense. EBITDA negativo torna DCF e múltiplos inviáveis. Mas incorporadora tem terrenos e imóveis com valor real. Neste caso, o ativo patrimonial (terrenos + imóveis) é o que define o piso — e provavelmente o valor justo.',
                  },
                  {
                    id: 'val-startup',
                    ...
                    correctZone: 'multiplos',
                    correctFeedback: 'Correto. Startups pré-receita são avaliadas por métodos qualitativos (Berkus, Scorecard) ou comparáveis de mercado — que são variações de múltiplos. O DCF é impossível sem fluxo, e o patrimonial ignora o valor da patente e equipe.',
                    wrongFeedback: 'Repense. Sem receita, o DCF não tem base e o patrimonial ignoraria o valor real (patente + equipe). Startups pré-receita são avaliadas por múltiplos qualitativos (Berkus) ou comparáveis de investimentos similares.',
                  },
                  {
                    id: 'val-varejo',
                    ...
                    correctZone: 'multiplos',
                    correctFeedback: 'Correto. Com pares listados na B3 (empresas comparáveis), os múltiplos de mercado são o método mais prático e defensável. EV/EBITDA do setor farmacêutico como referência + complemento com DCF para triangular.',
                    wrongFeedback: 'Repense. Quando existem empresas comparáveis listadas em bolsa, os múltiplos de mercado são o método mais objetivo. Rede de farmácias com EBITDA claro e pares na B3 é caso perfeito para EV/EBITDA setorial.',
                  },
                ],
              },
            },
          ...
          },
          {
            ...
            body: [
              { kind: 'heading', text: 'Capital de Giro Líquido = Ativo Circulante − Passivo Circulante' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: 'Os 4 Componentes do Ciclo' },
              {
                kind: 'step-flow',
                steps: [
                  { id: 'estoque', label: 'Estoque', description: 'Dinheiro parado em produto. PME = 360 ÷ Giro. Meta: reduzir sem causar ruptura. Just-in-time e previsão de demanda são as principais alavancas.' },
                  { id: 'receber', label: 'Contas a Receber', description: 'Dinheiro que o cliente deve. PMR = (Contas a Receber ÷ Receita) × 360. Risco: inadimplência (média 5–8% no Brasil). Antecipar recebíveis custa 1,5–4%/mês.' },
                  { id: 'pagar', label: 'Contas a Pagar', description: 'Quanto tempo o fornecedor financia a empresa. PMP = (Fornecedores ÷ Compras) × 360. Negociar prazos maiores (30→60→90 dias) é financiamento gratuito.' },
                  { id: 'caixa', label: 'Caixa', description: 'Reserva de segurança. Regra: mínimo 3–6 meses de despesas fixas em aplicação com liquidez diária. Nunca em cheque especial (>300%/ano).' },
                ],
              },
              { kind: 'heading', text: 'Estratégias para Otimizar' },
              {
                kind: 'paragraph',
                text: 'Reduzir estoque (just-in-time, dropshipping). Antecipar recebíveis (desconto de duplicatas). Alongar pagamentos (negociar 30→60→90 dias). Descontos à vista para o cliente (3–5% para pagar antecipado). Cada alavanca age em um ponto do ciclo — use a que tem menor custo de oportunidade primeiro.',
              },
            ],
            application: {
              kind: 'compare-and-drag',
              compare: {
                columnHeaders: ['Efeito no Ciclo Financeiro', 'Custo/Benefício', 'Quando priorizar'],
                rows: [
                  { label: 'Reduzir estoque', values: ['Diminui PME → encurta ciclo', 'Sem custo direto, libera caixa imediato', 'Quando estoque gira lento e sobra produto'], viz: 'bars' },
                  { label: 'Antecipar recebíveis', values: ['Diminui PMR → encurta ciclo', 'Custo de 1,5–4%/mês (antecipação)', 'Quando cliente paga em 60+ dias e há urgência'], viz: 'bars' },
                  { label: 'Alongar pagamentos', values: ['Aumenta PMP → encurta ciclo', 'Sem custo — negociação com fornecedor', 'Primeiro a tentar — financiamento gratuito'], viz: 'icons' },
                  { label: 'Desconto por antecipação', values: ['Diminui PMR indiretamente', 'Custo: 3–5% de desconto dado ao cliente', 'Quando precisa de caixa e o cliente tem poder'], viz: 'icons' },
                ],
              },
              drag: {
                ...
                zones: [
                  ...
                  { id: 'neutro', label: 'Impacto neutro ou indireto' },
                ],
                items: [
                  {
                    id: 'cg-prazo-cliente',
                  ...
                  },
                  {
                    ...
                    correctZone: 'melhora',
                    correctFeedback: 'Correto — melhora. Aumentar o PMP (prazo de pagamento) encurta o ciclo financeiro. O fornecedor financia por mais tempo — é financiamento gratuito. Essa é a primeira alavanca a explorar.',
                    wrongFeedback: 'Repense. Aumentar PMP (tempo para pagar fornecedor) encurta o ciclo financeiro = menos capital próprio necessário. O fornecedor está, na prática, financiando sua operação sem cobrar juros.',
                  },
                  {
                    id: 'cg-estoque-just',
                    label: 'Implantar sistema just-in-time de estoque',
                    sublabel: 'Empresa passa a comprar insumos apenas quando há pedido confirmado, reduzindo PME de 45 para 15 dias.',
                    correctZone: 'melhora',
                    correctFeedback: 'Correto — melhora significativamente. Reduzir PME de 45 para 15 dias encurta o ciclo operacional em 30 dias e libera caixa imobilizado no estoque. Sem custo direto — só mudança de processo.',
                  ...
                  },
                  {
                    ...
                    wrongFeedback: 'Repense. Cheque especial passa de 300%/ano. Cada mês usando esse crédito corrói margem e agrava o problema de caixa. A alternativa é antecipação de recebíveis (1,5–4%/mês) ou capital de giro negociado.',
                  },
                  {
                    ...
                    wrongFeedback: 'Repense. Dar desconto de 4% ao cliente que paga antecipado encurta o PMR — o dinheiro entra mais rápido. Se antecipar o recebível no banco custaria mais de 4%/mês, o desconto ao cliente é mais barato.',
                  },
                ],
              },
            },
          ...
          },
          {
            id: 'M6-0-cap4',
            type: 'chapter',
            title: 'Diagnóstico Integrado — Precificação e Rentabilidade',
            subtitle: 'Markup, margem, break-even e ponto de equilíbrio: os números que todo gestor precisa calcular de cabeça.',
            opening: {
              leadText: 'Preço é a única variável do mix que gera receita — todas as outras geram custo. Mas precificar sem entender markup, margem e ponto de equilíbrio é navegar sem bússola. Esses três conceitos, juntos, revelam se o negócio é viável e em que volume.',
            },
            body: [
              { kind: 'heading', text: 'Markup vs Margem — A Armadilha que Engole Empreendedores' },
              {
                kind: 'paragraph',
                text: 'Markup de 100% não é margem de 100% — é margem de 50%. Markup de 50% é margem de 33%. Markup de 30% é margem de 23%. Muitos empreendedores acham que têm 50% de margem quando têm 33% — e precificam abaixo do necessário sem saber.',
              },
              { kind: 'heading', text: 'Ponto de Equilíbrio e Margem de Contribuição' },
              {
                kind: 'paragraph',
                text: 'PE (unidades) = Custos Fixos ÷ (Preço − Custo Variável). Se Custos Fixos = R$ 30.000, Preço = R$ 100, CV = R$ 40: PE = 30.000 ÷ 60 = 500 unidades. Abaixo de 500 = prejuízo. Acima = lucro. Margem de Contribuição negativa é o sinal mais grave: cada venda aumenta o prejuízo — vender mais piora a situação.',
              },
              { kind: 'heading', text: '3 Abordagens de Precificação' },
              {
                kind: 'pillar-grid',
                pillars: [
                  { id: 'custo', label: 'Baseada em Custo', description: 'Custo + margem = preço. Garante margem mínima mas ignora o que o cliente paga. Risco: produto caro demais para o mercado.' },
                  { id: 'valor', label: 'Baseada em Valor', description: 'Preço = valor percebido pelo cliente. iPhone: custo ~US$ 400, preço ~US$ 1.200. Requer pesquisa profunda. Captura o máximo.' },
                  { id: 'mercado', label: 'Baseada em Competição', description: 'Referência do mercado ± posicionamento. Risco: race to bottom. Custo define o piso, mercado define a faixa, valor define o teto.' },
                ],
              },
            ],
            application: {
              kind: 'compare-and-drag',
              compare: {
                columnHeaders: ['Fórmula', 'Armadilha comum', 'Exemplo prático'],
                rows: [
                  { label: 'Markup 100%', values: ['Preço = Custo × 2', '"Tenho 100% de margem" (errado)', 'Custo R$ 50 → Preço R$ 100 → Margem real 50%'], viz: 'bars' },
                  { label: 'Markup 50%', values: ['Preço = Custo × 1,5', '"Tenho 50% de margem" (errado)', 'Custo R$ 50 → Preço R$ 75 → Margem real 33%'], viz: 'bars' },
                  { label: 'Margem de Contribuição', values: ['MC = Preço − Custo Variável', 'MC negativa = cada venda piora', 'MC R$ 60 → PE = Fixos ÷ 60'], viz: 'icons' },
                  { label: 'Break-Even', values: ['PE = Fixos ÷ MC unitária', '"Vendo muito mas nunca sobra"', 'R$ 30K fixos ÷ R$ 60 MC = 500 und/mês'], viz: 'icons' },
                ],
              },
              drag: {
                instruction: 'Toque no cenário do negócio, depois toque no diagnóstico correto:',
                zones: [
                  { id: 'viavel', label: 'Negócio viável' },
                  { id: 'prejuizo', label: 'Opera no prejuízo' },
                  { id: 'risco', label: 'Risco oculto — revisar' },
                ],
                items: [
                  {
                    id: 'prec-restaurante',
                    label: 'Restaurante vende 1.040 pratos/mês a R$ 55',
                    sublabel: 'Custo variável por prato: R$ 18. Custos fixos: R$ 45.000/mês.',
                    correctZone: 'prejuizo',
                    correctFeedback: 'Correto — opera no prejuízo. MC = R$ 37/prato. PE = 45.000 ÷ 37 = 1.216 pratos. Vende 1.040 < 1.216 = prejuízo de ~R$ 6.500/mês. Precisa subir preço, reduzir fixos ou vender mais 176 pratos/mês.',
                    wrongFeedback: 'Repense. MC = R$ 55 − R$ 18 = R$ 37. PE = R$ 45.000 ÷ R$ 37 = 1.216 pratos/mês. O restaurante vende 1.040 — abaixo do ponto de equilíbrio. Resultado: prejuízo de ~R$ 6.500/mês.',
                  },
                  {
                    id: 'prec-saas',
                    label: 'SaaS cobra R$ 200/mês, custo variável R$ 8/mês por cliente',
                    sublabel: 'Custos fixos de R$ 40.000/mês. Base atual: 250 clientes.',
                    correctZone: 'viavel',
                    correctFeedback: 'Correto — viável e lucrativo. MC = R$ 192/cliente. PE = 40.000 ÷ 192 ≈ 209 clientes. Com 250 clientes, supera o break-even em 41 clientes = ~R$ 7.900/mês de lucro. Margem de contribuição altíssima (96%).',
                    wrongFeedback: 'Repense. MC = R$ 200 − R$ 8 = R$ 192. PE = R$ 40.000 ÷ R$ 192 ≈ 209 clientes. Com 250 clientes, está 41 acima do PE. Negócio lucrativo com margem de contribuição de 96% — excelente modelo.',
                  },
                  {
                    id: 'prec-markup-erro',
                    label: 'Consultora aplica "50% de margem" sobre o custo do projeto',
                    sublabel: 'Custo do projeto: R$ 6.000. Ela cobra R$ 9.000 achando que tem 50% de margem.',
                    correctZone: 'risco',
                    correctFeedback: 'Correto — risco oculto. Markup de 50% sobre custo não é margem de 50% — é margem de 33%. R$ 3.000 de lucro ÷ R$ 9.000 de receita = 33,3%. Se ela planejou com 50% de margem, está 17pp abaixo do esperado.',
                    wrongFeedback: 'Repense. Markup de 50% sobre custo: R$ 6.000 × 1,5 = R$ 9.000. Mas margem = (R$ 9.000 − R$ 6.000) ÷ R$ 9.000 = 33,3% — não 50%. A confusão entre markup e margem cria uma falsa sensação de rentabilidade.',
                  },
                  {
                    id: 'prec-mc-negativa',
                    label: 'Startup oferece produto a R$ 50, custo variável R$ 65',
                    sublabel: 'Estratégia de crescimento: queimar preço para ganhar mercado. Custos fixos R$ 20.000/mês.',
                    correctZone: 'prejuizo',
                    correctFeedback: 'Correto — e perigoso. MC negativa de − R$ 15 significa que cada venda aumenta o prejuízo. Vender mais não resolve — piora. Dobrar as vendas dobra a perda. Esse modelo só funciona se houver monetização futura diferente do preço atual.',
                    wrongFeedback: 'Repense. MC = R$ 50 − R$ 65 = −R$ 15 por unidade. Margem de Contribuição negativa é o sinal mais grave em finanças: cada venda piora a situação. O break-even é matematicamente impossível com esse preço e custo.',
                  },
                  {
                    id: 'prec-premium',
                    label: 'Consultoria cobra R$ 15.000 por projeto com custo de R$ 3.000',
                    sublabel: 'Mercado concorrente cobra R$ 5.000–8.000. Cliente gerou R$ 150.000 de receita incremental.',
                    correctZone: 'viavel',
                    correctFeedback: 'Correto — viável com precificação baseada em valor. Margem de 80% (R$ 12.000 de lucro ÷ R$ 15.000). O preço captura ~10% do valor gerado ao cliente — proporcional ao resultado entregue. McKinsey e Bain operam nessa lógica.',
                    wrongFeedback: 'Repense. MC = R$ 12.000, margem de 80%. Preço baseado em valor: cobra proporcional ao resultado que entrega (R$ 15.000 de honorários para R$ 150.000 gerados = ROI de 10× para o cliente). Totalmente viável.',
                  },
                ],
              },
            },
            synthesis: {
              closingText: 'Análise financeira, valuation, capital de giro e precificação não são quatro temas separados — são {{quatro lentes do mesmo negócio}}. A empresa que entende sua estrutura (vertical), sua tendência (horizontal), seu ciclo (giro) e seu preço (margem) tem informação para decidir. As outras adivinham.',
              keyInsights: [
                'Markup de 50% não é margem de 50% — é 33%. {{Esta confusão pode fazer uma empresa operar com 17% menos lucro do que imagina}}.',
                'Margem de Contribuição negativa: vender mais piora. Corrija preço ou custo variável antes de qualquer investimento em crescimento.',
                'Integre os 4 capítulos: estrutura (V/H) → valor (valuation) → fluxo (capital de giro) → preço (MC + break-even). Esse é o diagnóstico financeiro completo.',
              ],
            },
          },
        ],
        ...
        blocks: [
          {
            ...
            body: [
                ...
                phases: [
                  {
                    ...
                    description: 'Preço = Custo Total + Margem desejada. Simples, garante margem mínima.',
                    action: 'Risco: ignora o que o cliente pagaria. Se o custo for alto, o preço fica fora do mercado. Uso: commodities, licitações, indústria com custo fixo claro.',
                  },
                  {
                    id: 'valor',
                    label: 'Baseada em Valor',
                    description: 'Preço = Valor percebido pelo cliente. iPhone: custo ~US$ 400, preço ~US$ 1.200.',
                    action: 'Captura o máximo da disposição a pagar. Requer pesquisa profunda. Uso: marcas fortes, produtos diferenciados, SaaS, consultoria.',
                  },
                  {
                    id: 'mercado',
                    label: 'Baseada em Competição',
                    description: 'Preço = Referência do mercado ± posicionamento.',
                    action: 'Risco: race to bottom — todos baixam preço até ninguém lucrar. Uso: e-commerce, varejo, mercados commoditizados. Custo define o piso, valor define o teto.',
                  },
                ],
              },
              { kind: 'heading', text: 'A Regra das 3 Camadas' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: 'Tiered Pricing — O Poder das 3 Opções' },
              {
                kind: 'paragraph',
            ...
            application: {
              ...
              drag: {
                ...
                items: [
                  ...
                  {
                    id: 'prec-consultoria',
                    label: 'Consultoria de estratégia que identifica R$ 500K de economia',
                    sublabel: 'O projeto levou 3 semanas de trabalho. Custo interno: R$ 15K. O cliente economizará meio milhão.',
                    correctZone: 'valor',
                    correctFeedback: 'Correto. Cobrar por custo (R$ 15K + margem = ~R$ 25K) deixa R$ 450K+ de valor na mesa. Cobrar por valor: 10% do ganho gerado = R$ 50K. A McKinsey cobra 1–5% do impacto — porque o preço é baseado no resultado, não no tempo.',
                  ...
                  {
                    id: 'prec-farmacia',
                    label: 'Farmácia de manipulação em bairro com 2 concorrentes',
                    sublabel: 'Produto diferenciado (manipulado), mas o cliente pesquisa preço antes de decidir onde fazer.',
                    correctZone: 'mercado',
                    correctFeedback: 'Correto — com nuance. Farmácia de manipulação tem diferenciação (produto personalizado) mas atua em mercado comparável. Estratégia híbrida: custo garante o piso, mercado define a faixa, e atendimento/prazo pode justificar um prêmio de 10–15%.',
                    wrongFeedback: 'Repense. Mesmo com produto diferenciado, se o cliente pesquisa preço entre concorrentes, o mercado ancora a decisão. A estratégia é referência de mercado + pequeno prêmio por atributos (velocidade, qualidade, atendimento).',
                  },
                ],
              },
            },
          ...
          },
          {
            ...
            body: [
              { kind: 'heading', text: 'Elasticidade-Preço da Demanda' },
              {
                kind: 'pillar-grid',
                pillars: [
                  { id: 'elastica', label: 'Demanda Elástica', description: 'Variação de 10% no preço → queda > 10% na demanda. Produtos não-essenciais, substituíveis. Ex: viagens, roupas de grife, restaurantes finos.' },
                  { id: 'inelastica', label: 'Demanda Inelástica', description: 'Variação de 10% no preço → queda < 10% na demanda. Essenciais, sem substituto. Ex: insulina, combustível, água encanada, cigarro.' },
                  { id: 'unitaria', label: 'Elasticidade Unitária', description: 'Variação de 10% no preço → queda de exatamente 10%. Raro na prática. Receita total permanece constante independente do preço.' },
                  { id: 'cruzada', label: 'Elasticidade Cruzada', description: 'Como o preço do concorrente afeta sua demanda. Alta = produtos substitutos. Baixa = complementares ou sem alternativa percebida.' },
                ],
              },
              { kind: 'heading', text: 'Psicologia do Preço — 3 Vieses que Todo Gestor Deve Usar' },
              {
                kind: 'step-flow',
                steps: [
                  { id: 'ancora', label: 'Preço Âncora', description: 'O primeiro preço que o consumidor vê define a referência mental. "De R$ 299 por R$ 199" funciona porque a âncora (299) estabelece o valor percebido — o desconto parece enorme mesmo que o produto sempre valesse R$ 199.' },
                  { id: 'charm', label: 'Charm Pricing', description: 'R$ 199 vende mais que R$ 200. O cérebro lê da esquerda para a direita: "1" parece menor que "2". Eficaz especialmente abaixo de limiares psicológicos (R$ 100, R$ 500, R$ 1.000).' },
                  { id: 'decoy', label: 'Efeito Decoy', description: 'Inserir uma terceira opção "sacrifício" torna outra mais atraente. Pipoca P: R$ 5. Pipoca G: R$ 8. Pipoca M: R$ 7. A M existe para fazer a G parecer obviamente melhor — 80% escolhem G.' },
                ],
              },
            ],
            application: {
              ...
              compare: {
                ...
                rows: [
                  { label: 'Demanda elástica', values: ['Perde >10% do volume — receita cai', 'Diferenciar antes de subir preço', 'Restaurante casual, roupas fast fashion'], viz: 'bars' },
                  { label: 'Demanda inelástica', values: ['Perde <10% do volume — receita sobe', 'Subir preço captura margem com pouco custo', 'Medicamentos, utilities, nicho especializado'], viz: 'bars' },
                  { label: 'Preço âncora alto', values: ['Desconto parece maior, conversão sobe', 'Mostrar preço original riscado antes do atual', 'E-commerce, Black Friday, serviços com planos'], viz: 'icons' },
                  { label: 'Tiered pricing', values: ['60-70% escolhem o plano do meio', 'Criar 3 opções — básico, pro, premium', 'SaaS, assinaturas, cursos online'], viz: 'icons' },
                ],
              },
              drag: {
                ...
                zones: [
                  ...
                  { id: 'depende', label: 'Depende do segmento / contexto' },
                ],
                items: [
                  {
                    id: 'el-insulina',
                    label: 'Insulina para diabético tipo 1',
                    sublabel: 'Medicamento sem substituto. Paciente precisa da dose exata independente do preço.',
                    correctZone: 'inelastica',
                    correctFeedback: 'Correto. Demanda inelástica clássica: o paciente não tem alternativa e a necessidade é vital. Subir 30% no preço gera queda mínima no volume. É por isso que regulação de preços de medicamentos existe.',
                    wrongFeedback: 'Repense. Insulina sem substituto para quem depende dela é inelástica — o consumidor compra independente do preço porque a alternativa é a morte. Alta inelasticidade justifica regulação estatal de preços.',
                  },
                  {
                    id: 'el-restaurante',
                    label: 'Restaurante casual em praça de alimentação de shopping',
                    sublabel: 'Rodeado por 12 concorrentes com preço médio similar. O cliente decide onde comer na hora.',
                    correctZone: 'elastica',
                    correctFeedback: 'Correto. Com 12 substitutos à vista e decisão por impulso, a demanda é elástica. Subir R$ 5 no prato pode custar 20-30% dos clientes para o vizinho. Diferenciação (exclusividade, ambiente, fila) reduz a elasticidade.',
                    wrongFeedback: 'Repense. Restaurante em praça de alimentação com muitos substitutos tem demanda elástica — o cliente literalmente olha para os outros lugares antes de decidir. Qualquer diferença relevante de preço impacta o volume.',
                  },
                  {
                    id: 'el-iphone',
                    ...
                    wrongFeedback: 'Repense. O ecossistema Apple (AirPods, Apple Watch, iCloud, apps pagos) cria custo de troca alto. Isso torna a demanda inelástica: subir o preço do iPhone não faz o usuário migrar para Android porque o custo de troca é maior.',
                  },
                  {
                    id: 'el-passagem',
                    label: 'Passagem aérea para destino de lazer',
                    sublabel: 'Viagem de férias para Cancún. Não é urgente — o cliente pesquisa por semanas antes de comprar.',
                    correctZone: 'elastica',
                    correctFeedback: 'Correto. Viagem de lazer com tempo de planejamento longo e múltiplos destinos substitutos = altamente elástica. Subir 15% o preço leva muitos clientes a escolher outro destino ou adiar a viagem.',
                    wrongFeedback: 'Repense. Lazer com alternativas (outros destinos, datas flexíveis, adiar) torna a demanda elástica. Diferente de viagem de negócios com data fixa — essa sim tem menor elasticidade pois o cliente não pode adiar.',
                  },
                  {
                    id: 'el-energia',
                    ...
                    wrongFeedback: 'Repense. Energia elétrica de monopolista local é o exemplo clássico de inelasticidade: sem alternativa, essencial e com custo de troca (geração própria) altíssimo. Regulação existe exatamente para controlar o poder de precificação.',
                  },
                ],
              },
            },
          ...
          },
          {
            ...
            subtitle: 'Markup de 50% não é margem de 50%. É margem de 33%. Este erro custa a muitas empresas 17% do lucro esperado.',
            opening: {
            ...
            body: [
              { kind: 'heading', text: 'Markup — Fator Sobre o Custo' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: 'Margem — Percentual do Preço' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: 'A Tabela que Todo Gestor Precisa Decorar' },
              {
                kind: 'pillar-grid',
                pillars: [
                  { id: 'mk100', label: 'Markup 100%', description: 'Margem REAL: 50%. Preço = 2× o custo. "Dobrei o preço" ≠ "Tenho 100% de margem".' },
                  { id: 'mk50', label: 'Markup 50%', description: 'Margem REAL: 33%. O erro mais comum: "aplico 50% de margem" quando a margem é 33%.' },
                  { id: 'mk30', label: 'Markup 30%', description: 'Margem REAL: 23%. Muitas empresas de varejo operam aqui sem saber.' },
                  { id: 'mk25', label: 'Markup 25%', description: 'Margem REAL: 20%. Abaixo disso, qualquer oscilação de custo elimina o lucro.' },
                ],
              },
            ],
            application: {
                ...
                items: [
                  {
                    ...
                    correctFeedback: 'Correto — ela está calculando markup, não margem. R$ 40 de lucro ÷ R$ 140 de preço = 28,5% de margem real. Ela acredita ter 40% mas tem 28,5% — diferença de 11,5pp que distorce todo o planejamento financeiro.',
                    wrongFeedback: 'Repense. Multiplicar o custo por 1,4 é markup de 40% — não margem de 40%. A margem real é (R$ 40 ÷ R$ 140) = 28,5%. Confundir os dois faz o empreendedor planejar com uma rentabilidade fictícia.',
                  },
                  {
                    id: 'mk-caso2',
                    ...
                    correctZone: 'correto',
                    correctFeedback: 'Correto — cálculo exato. A fórmula Preço = Custo ÷ (1 − Margem%) é a forma correta de precificar com margem definida. R$ 43 de lucro ÷ R$ 123 de preço = 35% de margem real.',
                    wrongFeedback: 'Repense. Este cálculo está correto. A fórmula Preço = Custo ÷ (1 − Margem%) garante a margem desejada sobre o preço de venda — não sobre o custo. É o método certo para quem quer definir margem, não markup.',
                  },
                  {
                    id: 'mk-caso3',
                    ...
                    correctZone: 'markup-como-margem',
                    correctFeedback: 'Correto — o markup é 100%, mas a margem é 50%. R$ 50 de lucro ÷ R$ 100 de preço = 50%. Dizer "100% de margem" cria expectativa errada sobre rentabilidade — especialmente na hora de calcular IR, distribuição e reinvestimento.',
                    wrongFeedback: 'Repense. Vender pelo dobro do custo = markup de 100%. Mas margem = lucro ÷ preço = R$ 50 ÷ R$ 100 = 50%. A diferença importa: ao calcular quanto fica no caixa depois dos impostos sobre receita, a base é o preço — não o custo.',
                  },
                  {
                    id: 'mk-caso4',
                    ...
                    correctFeedback: 'Correto — venda abaixo do custo. R$ 90 de preço < R$ 95 de custo = prejuízo de R$ 5 por unidade. Desconto sem verificar se o preço ainda cobre o custo é erro grave — especialmente quando os custos subiram desde o último reajuste.',
                  ...
                  },
                  {
                    ...
                    correctZone: 'markup-como-margem',
                    correctFeedback: 'Correto — ele está calculando markup sobre custo (25%), não margem sobre preço. A margem real é R$ 25 ÷ R$ 125 = 20%. São 5pp de diferença que, em escala, mudam completamente a análise de rentabilidade.',
                    wrongFeedback: 'Repense. Dividir o lucro pelo custo é markup, não margem. Margem = lucro ÷ preço = R$ 25 ÷ R$ 125 = 20%. A base importa: markup usa custo, margem usa preço — e preço é o número que aparece na nota fiscal.',
                  },
                ],
              },
            },
            synthesis: {
              closingText: 'Markup e margem são dois números sobre o mesmo lucro — mas com bases diferentes. {{Confundir os dois é planejar em cima de uma ilusão}}. Antes de definir meta de crescimento, distribuição ou reajuste, certifique-se de qual número você está usando.',
              keyInsights: [
                'Markup usa o custo como base. Margem usa o preço. Markup de 50% = margem de 33% — {{nunca são iguais}}.',
                'A fórmula correta para precificar com margem definida: Preço = Custo ÷ (1 − Margem%). Não multiplique — divida.',
          ...
          },
          {
            ...
            opening: {
              leadText: 'Ponto de equilíbrio não é um exercício contábil — é a resposta para "meu negócio é viável neste volume?". Margem de Contribuição negativa é o sinal mais perigoso que existe: significa que vender mais piora a situação. Entender os dois protege o negócio de crescer para o prejuízo.',
            },
            body: [
              { kind: 'heading', text: 'Margem de Contribuição — A Unidade Fundamental' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: 'Ponto de Equilíbrio — O Piso de Sobrevivência' },
              {
                kind: 'paragraph',
              ...
              { kind: 'heading', text: 'Margem de Segurança — Quanto Você Pode Perder' },
              {
                kind: 'paragraph',
            ...
            application: {
              ...
              compare: {
                ...
                rows: [
                  ...
                  { label: 'Break-Even (unidades)', values: ['PE = Fixos ÷ MC', 'Mínimo de vendas para não ter prejuízo', 'PE > capacidade operacional'], viz: 'bars' },
                  { label: 'Break-Even (receita)', values: ['PE = Fixos ÷ MC%', 'Receita mínima de sobrevivência', 'PE próximo à receita atual = risco alto'], viz: 'bars' },
                ...
                items: [
                  {
                    ...
                    correctZone: 'prejuizo',
                    correctFeedback: 'Correto. 1.040 vendas < PE de 1.216 = prejuízo de (1.216 − 1.040) × R$ 37 = ~R$ 6.500/mês. Precisa vender mais 176 pratos por mês (7 por dia) ou reduzir fixos em R$ 6.500 para empatar.',
                    wrongFeedback: 'Repense. PE = R$ 45.000 ÷ R$ 37 = 1.216 pratos. Vendendo 1.040 — 176 abaixo do PE. Resultado: prejuízo de 176 × R$ 37 = ~R$ 6.500/mês. O restaurante opera no vermelho.',
                  },
                  {
                    id: 'be-saas',
                    ...
                    correctZone: 'lucro',
                    correctFeedback: 'Correto — e com folga confortável. PE = 40.000 ÷ 192 ≈ 209 clientes. Com 300, supera o PE em 91 clientes = R$ 17.472 de lucro mensal. Margem de segurança: (300−209) ÷ 300 = 30,3%. Pode perder 90 clientes antes de entrar no vermelho.',
                    wrongFeedback: 'Repense. PE = R$ 40.000 ÷ R$ 192 ≈ 209. Com 300 clientes, supera o PE em 91 = lucro de ~R$ 17.500/mês. Margem de segurança de 30% significa que pode perder quase um terço dos clientes sem entrar no prejuízo.',
                  },
                  {
                    id: 'be-mc-negativa',
                    ...
                    correctZone: 'critico',
                    correctFeedback: 'Correto — situação crítica. MC = R$ 50 − R$ 70 = −R$ 20 por unidade. Não existe PE possível com MC negativa: cada venda piora. Vender 1.000 unidades gera R$ 20.000 de perda ALÉM dos fixos. Crescimento com MC negativa é acelerador de falência.',
                    wrongFeedback: 'Repense. MC negativa (R$ 50 − R$ 70 = −R$ 20) é o sinal mais grave. O break-even é matematicamente impossível: cada venda adiciona R$ 20 de prejuízo. Crescer nesse modelo é destruir caixa mais rápido. Corrija o preço ou o CV antes de qualquer expansão.',
                  },
                  {
                    id: 'be-margem-baixa',
                    ...
                    correctZone: 'critico',
                    correctFeedback: 'Correto — tecnicamente no lucro, mas em situação crítica. Margem de segurança de 3%: basta perder 30 clientes para entrar no vermelho. Qualquer sazonalidade, inadimplência ou custo inesperado vira prejuízo. Meta urgente: reduzir fixos ou aumentar volume para margem de segurança > 15%.',
                    wrongFeedback: 'Repense. Lucro existe (980 > 950), mas margem de segurança de 3% é perigosa. Perder 30 vendas = prejuízo. Qualquer evento adverso — sazonalidade, aumento de aluguel, inadimplência — elimina o resultado. Situação crítica apesar do lucro técnico.',
                  },
                  {
                    id: 'be-industria',
                    ...
                    correctZone: 'lucro',
                    correctFeedback: 'Correto — lucrativa com boa margem de segurança. PE = 120.000 ÷ 150 = 800. Produz 1.400 = 600 acima do PE = R$ 90.000 de lucro. Margem de segurança: (1.400−800) ÷ 1.400 = 42,8%. Pode absorver quedas significativas de demanda sem entrar no prejuízo.',
                    wrongFeedback: 'Repense. PE = R$ 120.000 ÷ R$ 150 = 800 unidades. Produz 1.400 — 600 acima do PE = R$ 90.000 de lucro mensal. Margem de segurança de 43% — ótima. A empresa aguenta perder quase metade do volume antes de entrar no vermelho.',
                  },
                ],
              },
            },
            synthesis: {
              closingText: 'Break-even não é destino — é piso. {{Operar abaixo do PE é sangriar lentamente}}. Operar perto do PE é vulnerável. A meta é margem de segurança > 20%: significa que o negócio aguenta surpresas sem entrar em crise imediata.',
              keyInsights: [
                'MC negativa: vender mais piora. Corrija preço ou custo variável antes de qualquer coisa — crescimento não resolve.',
                'Margem de segurança < 15% = empresa vulnerável. Qualquer choque externo (sazonalidade, inadimplência, custo) vira crise.',
