        ...
        blocks: [
          // ═══════════════ GL1: Era Digital ═══════════════
          {
            ...
            steps: [
              ...
              {
                type: 'calculator',
                title: 'Custo Composto de NÃO Digitalizar (5 anos)',
                sliders: [
                  { id: 'receita_anual', label: 'Receita anual atual', min: 500000, max: 50000000, default: 5000000, unit: 'R$' },
                  { id: 'perda_anual_pct', label: 'Perda anual por ineficiência (%)', min: 1, max: 15, default: 5, unit: '%' },
                  { id: 'crescimento_mercado', label: 'Crescimento do mercado digital (%/ano)', min: 5, max: 30, default: 12, unit: '%' },
                  { id: 'anos', label: 'Anos sem digitalizar', min: 1, max: 10, default: 5, unit: 'anos' },
                ],
                formula: 'receita_anual * (Math.pow(1 + crescimento_mercado/100, anos) - Math.pow(1 - perda_anual_pct/100, anos))',
                resultLabel: 'Gap acumulado em relação ao mercado',
                resultSuffix: ' total',
                interpretation: [
                  { max: 2000000, label: 'Gap gerenciável — mas crescendo rápido', color: 'amber' },
                  { max: 10000000, label: 'Gap crítico — concorrentes distanciando', color: 'red' },
                  { max: 999999999999, label: 'Gap irreversível — risco existencial', color: 'red' },
                ],
              },
              {
                type: 'sandbox',
          ...
          // ═══════════════ TEORIA: Texto profundo + Author Cards + Timeline ═══════════════
          {
            id: 'M1-0-t1',
            type: 'living-text',
            title: 'Era Digital, Inovação e Transformação Digital',
            estimatedReading: 'Leitura densa · interaja conforme avança',
            body: '**A EVOLUÇÃO DA TECNOLOGIA NAS EMPRESAS**\n\nA evolução histórica da tecnologia nas empresas pode ser segmentada em três fases distintas — e entender em qual fase sua organização está é o primeiro passo para sair da inércia digital.\n\n[[anim:phases3]]\n\nNa **Fase 1 — Infraestrutura** (anos 2000), o foco era estabilidade de servidores, redes operacionais e [[concept:sla|SLA]]. TI era custo operacional: mantinha os sistemas no ar para que o negócio acontecesse. Foi nesse contexto que [[author:carr|Nicholas Carr]] publicou em 2003 um dos artigos mais provocativos da Harvard Business Review.\n\n[[quote:carr-quote]]\n\nNa **Fase 2 — Processo** (anos 2010), os sistemas integrados de gestão como [[concept:erp|ERPs]] e CRMs entraram no cotidiano da gestão. A tecnologia passou a organizar fluxos, padronizar operações e gerar dados confiáveis. Empresas como Magazine Luiza começaram a integrar lojas físicas e canais digitais — não como projeto isolado de TI, mas como nova forma de operar.\n\nNa **Fase 3 — Estratégia** (anos 2020 em diante), a tecnologia define a criação de produtos, o atendimento ao cliente e a capacidade de inovar. Tornou-se pilar de competitividade e reputação. Dados, algoritmos e efeitos de rede criam vantagens que se auto-reforçam — quanto mais dados, melhor o algoritmo; melhor o algoritmo, mais usuários; mais usuários, mais dados. [[author:brynjolfsson|Brynjolfsson]] (MIT, 2014) chamou esse momento de "segunda era das máquinas".\n\n[[pause:fase-empresa]]\n\n**TRANSFORMAÇÃO DIGITAL**\n\nA transformação digital é o processo de integração de tecnologias digitais em todas as áreas de uma organização, mudando a forma como ela opera e entrega valor aos seus clientes. Não se trata apenas de implementar novas tecnologias — é uma mudança cultural que exige que organizações desafiem continuamente o status quo, experimentem e se sintam confortáveis com o fracasso.\n\nAqui é importante distinguir três conceitos que costumam ser confundidos: [[concept:digitizacao|digitização]], [[concept:digitalizacao|digitalização]] e [[concept:transformacao|transformação digital]]. A maioria das PMEs brasileiras está presa entre os dois primeiros.\n\n**GOVERNANÇA DIGITAL**\n\nGovernança digital é o conjunto de práticas e processos que garantem que a tecnologia seja usada de maneira eficiente e alinhada às estratégias organizacionais. Envolve a gestão de recursos tecnológicos, a segurança da informação, a conformidade com regulamentações e a garantia de que os investimentos em tecnologia estejam gerando valor real para a organização.\n\nEm um ambiente em que dados são o principal ativo, não dar o devido valor à governança digital pode colocar em risco a sustentabilidade da organização ao longo do tempo. As principais frentes são: segurança da informação (proteger contra ameaças internas e externas), alinhamento estratégico (uso da tecnologia conectado à estratégia de longo prazo), melhoria da eficiência (processos automatizados reduzem desperdícios) e conformidade legal (LGPD no Brasil, GDPR na Europa).\n\n**SINERGIA ENTRE GESTÃO DA INOVAÇÃO E TRANSFORMAÇÃO DIGITAL**\n\nOs Sistemas de Gestão da Inovação (SGI) e a Transformação Digital (TD) frequentemente evoluem em paralelo — mas geram benefícios mútuos quando integrados. O SGI orienta as iniciativas de TD ao estruturar processos para lidar com projetos de alta incerteza, enquanto a TD oferece as ferramentas tecnológicas para potencializar a eficácia desses sistemas.\n\nA integração pode ser compreendida em quatro elementos: **estrutura de projetos** (SGI gerencia incertezas com metodologias; TD fornece ferramentas de colaboração em tempo real), **processos** (SGI organiza o fluxo de ideação; TD automatiza o funil), **cultura** (SGI estimula a experimentação e aceitação do erro; TD democratiza dados para decisões ágeis) e **resultados** (SGI mantém foco estratégico no ROI; TD entrega analytics para medir impacto em larga escala).\n\n**OS PILARES DA GOVERNANÇA DIGITAL**\n\nPilares são estruturas que permitem que algo se mantenha firme. Para a governança digital manter-se sólida, quatro pilares precisam funcionar conjuntamente — caso contrário, a casa pode desabar.\n\n**Estratégia** estabelece como a tecnologia será usada para atingir objetivos da organização. Inclui definição de prioridades, planejamento de investimentos e indicadores para medir resultados. Não faz sentido investir em tecnologia se essa inteligência não estiver alinhada ao que a empresa almeja atingir.\n\n**Riscos e Segurança** identifica, avalia e mitiga ameaças. Inclui políticas de segurança como criptografia, [[concept:2fa|autenticação em dois fatores]] e treinamento contínuo dos colaboradores. A maior vulnerabilidade não é técnica — é humana.\n\n**Políticas e Procedimentos** estabelecem regras claras sobre uso de tecnologia. Quanto mais padronizados os processos, mais fidedignos os dados — e mais seguras as decisões. Diretrizes para uso de dispositivos móveis, acesso a dados sensíveis e escolha de fornecedores entram aqui.\n\n**Monitoramento Contínuo** garante que sistemas e processos sejam ajustados conforme a tecnologia avança. Não faz sentido construir uma casa linda e não mantê-la atualizada.\n\n[[pause:pilar-fraco]]\n\n**CULTURA ORGANIZACIONAL E GESTÃO DA MUDANÇA**\n\nA tecnologia é apenas um dos componentes da transformação digital. O fator humano e a cultura organizacional representam os maiores desafios — e simultaneamente os maiores facilitadores do sucesso. A resistência à mudança é fenômeno natural em organizações com identidades culturais fortes e processos tradicionais.\n\nAs barreiras mais comuns à inovação digital são: medo do erro, resistência à mudança, punição ao fracasso (que inibe a experimentação necessária), culturas centralizadoras que inibem o protagonismo dos colaboradores, e desalinhamento entre o discurso da liderança e as práticas diárias. Outra barreira sutil: tratar a transformação como responsabilidade exclusiva do setor de TI — o que compromete o esforço coletivo.\n\nA gestão da mudança bem-sucedida combina cinco passos: **diagnóstico e alinhamento estratégico** (compreender o cenário atual e definir a visão), **liderança ativa** (líderes incorporando comportamentos digitais primeiro), **comunicação transparente** (explicar o "porquê" da mudança), **treinamento e capacitação** (desenvolver habilidades técnicas e soft skills) e **espaços seguros para experimentar** (ambientes onde ideias podem ser testadas sem medo).\n\nEstudos indicam que práticas estruturadas de gestão da mudança impactam positivamente a atitude dos funcionários, reduzindo o ceticismo e o temor frente às novas ferramentas.\n\n**FRAMEWORKS DE GOVERNANÇA**\n\nA implementação da governança digital não exige criar processos do zero — exige adaptar frameworks reconhecidos que equilibram controle e agilidade.\n\nO **[[concept:cobit|COBIT]]** (Control Objectives for Information and Related Technologies) é a referência global para governança de TI empresarial. Atua no nível estratégico, conectando objetivos de negócio às metas de tecnologia. Define "o que" deve ser feito para garantir entrega de valor.\n\nA **[[concept:iso38500|ISO/IEC 38500]]** fornece princípios para a governança corporativa da TI, orientando dirigentes sobre uso eficaz, eficiente e aceitável da tecnologia. Baseia-se em três pilares: avaliação do uso atual e futuro, direção para implementação de planos, e monitoramento de conformidade e desempenho.\n\nO **[[concept:itil|ITIL 4]]** foca na parte tática e operacional, organizando fluxos para entrega de serviços de TI. A versão 4 integra inteligência artificial e computação em nuvem.\n\n**Para PMEs**, governança digital simplificada significa: backup automático diário, autenticação em dois fatores em todas as contas, um responsável por tecnologia (mesmo acumulando função), política de senhas com gerenciador, e revisão trimestral de ferramentas e custos. Custo: R$ 0 a R$ 50/mês. Custo de não fazer: potencialmente o negócio inteiro.\n\n**FERRAMENTAS DIGITAIS PARA GESTÃO DA INOVAÇÃO**\n\nDuas práticas dominam o discurso atual sobre ferramentas digitais para inovação. A primeira é **Analytics-to-Value (AtV)** — uso de digital e analytics para otimizar portfólio e reduzir custos de produtos. Enquanto métodos tradicionais focam em componentes isolados, o AtV explora dados internos e externos em larga escala, gerando insights em poucos dias para todo o portfólio.\n\nA segunda é a **Tomada de Decisão Baseada em Dados** (Data-Driven Decision Making — DDDM) — uso de fatos, métricas e dados para orientar decisões comerciais estratégicas. Mas a tecnologia de análise sozinha não é suficiente: é necessário criar uma cultura que estimule pensamento crítico e curiosidade em todos os níveis.\n\n[[calc:custo-composto]]\n\n**GOVERNANÇA DE DADOS E O MARCO REGULATÓRIO BRASILEIRO**\n\nA transformação digital no Brasil ocorre sob um arcabouço legal rigoroso que visa proteger o cidadão e incentivar a inovação responsável. A **Lei Geral de Proteção de Dados** (LGPD) e a **Lei do Governo Digital** (14.129/2021) são os pilares desse ecossistema.\n\nO **sandbox regulatório** é um ambiente experimental que permite testagem de modelos de negócios inovadores com flexibilidade temporária em normas e penalidades. O Marco Civil das Startups (LC 182/21) institucionalizou essa prática. A ANPD lançou recentemente um sandbox focado em Inteligência Artificial e Proteção de Dados, com ênfase em transparência algorítmica, mitigação de vieses e segurança no uso de dados pessoais para treinar modelos generativos.\n\n**TENDÊNCIAS FUTURAS: IA, AGENTES AUTÔNOMOS E REGTECH**\n\nO futuro da gestão da inovação está intrinsecamente ligado à evolução da Inteligência Artificial. Em 2025, profissionais de compliance e governança veem a IA não apenas como ferramenta de automação, mas como vetor de aculturamento ético.\n\nDiferente da automação robótica tradicional (RPA), os agentes de IA possuem capacidades de percepção, raciocínio adaptativo e ação autônoma. Isso redefine a governança: as empresas agora precisam gerenciar agentes que tomam decisões independentes e acessam dados sensíveis. A **observabilidade** torna-se a prioridade número um — não se pode gerenciar ou proteger o que não se vê.\n\nAs **RegTechs** (Regulatory Technology) estão em plena expansão, utilizando IA para automatizar verificações de KYC e triagens de AML. Em 2025, o compliance deixa de ser focado em evitar multas e passa a ser motor de confiança e reputação. A detecção preditiva de anomalias permite responder a riscos em tempo real.\n\n[[pause:proximos-12-meses]]',
            refs: [
              {
                id: 'carr',
                label: 'Nicholas Carr',
                kind: 'author',
                summary: 'Escritor e pesquisador que provocou debate global sobre o papel estratégico da TI nas empresas.',
                year: 2003,
                affiliation: 'Harvard Business Review',
                details: 'Autor do artigo "IT Doesn\'t Matter" (HBR, 2003) e do livro "Does IT Matter?" (2004). Argumentou que TI se tornou commodity — disponível para todos, portanto incapaz de gerar vantagem competitiva sustentável. Acertou que TI sem estratégia não gera diferencial, mas subestimou a Fase 3 — quando dados e algoritmos viraram o próprio negócio.',
              },
              {
                id: 'brynjolfsson',
                label: 'Erik Brynjolfsson',
                kind: 'author',
                summary: 'Economista do MIT especializado em impacto da tecnologia na produtividade e economia.',
                year: 2014,
                affiliation: 'MIT Sloan / Stanford Digital Economy Lab',
                details: 'Resolveu o Paradoxo de Solow demonstrando que ganhos de TI requerem investimentos complementares em reorganização organizacional 5-10x maiores que o investimento em tecnologia. Co-autor de "The Second Machine Age" (2014) com Andrew McAfee.',
              },
            ],
            concepts: [
              {
                ...
                definition: 'Contrato que define o nível de serviço esperado entre fornecedor e cliente. Em TI, mede coisas como uptime (% do tempo em que o sistema está no ar), tempo de resposta e tempo de resolução de incidentes.',
                example: 'Um data center com SLA de 99,9% pode ficar fora do ar no máximo 8 horas e 45 minutos por ano. SLA de 99,99% (4 noves) reduz para 52 minutos.',
              },
              {
                id: 'erp',
                term: 'ERP — Enterprise Resource Planning',
                definition: 'Sistema integrado de gestão empresarial que conecta áreas como finanças, estoque, vendas, RH e produção em uma única base de dados.',
                example: 'SAP, Oracle, TOTVS e Omie são ERPs. Antes deles, cada departamento tinha sua planilha — depois deles, a empresa enxerga o todo em tempo real.',
              },
              {
                id: '2fa',
                term: '2FA — Autenticação em Dois Fatores',
                definition: 'Camada extra de segurança que exige duas formas de identificação para acesso: algo que você sabe (senha) + algo que você tem (código no celular) ou é (biometria).',
                example: 'Quando o banco pede senha + código por SMS para confirmar uma transferência, isso é 2FA. Bloqueia 99,9% dos ataques baseados em senha vazada.',
              },
              {
                id: 'digitizacao',
                term: 'Digitização',
                definition: 'Conversão de informação física em formato digital. É o nível mais básico — escanear um documento, fotografar uma nota fiscal, transformar um cadastro em papel em planilha.',
                example: 'Uma loja que escaneia todas as notas fiscais e guarda em PDF na nuvem fez digitização. Mas se ainda preenche estoque à mão, não fez digitalização.',
              },
              {
                id: 'digitalizacao',
                term: 'Digitalização (de processos)',
                definition: 'Uso de tecnologia digital para automatizar e otimizar fluxos de trabalho existentes. O processo continua o mesmo, mas executado por software.',
                example: 'Uma empresa que substitui o pedido manual por formulário online integrado ao estoque fez digitalização. O fluxo é o mesmo (pedido → estoque), só ficou automático.',
              },
              {
                id: 'transformacao',
                term: 'Transformação Digital',
                definition: 'Repensar o modelo de negócio e a proposta de valor a partir de capacidades digitais. Não é melhorar o que existe — é redesenhar o que a empresa É.',
                example: 'A Magazine Luiza não digitalizou suas lojas — transformou-as em mini centros de distribuição de uma plataforma digital. Mudou o que ela é, não só como opera.',
              },
              {
                id: 'cobit',
                term: 'COBIT',
                definition: 'Control Objectives for Information and Related Technologies. Framework global de governança e gestão de TI empresarial criado pela ISACA em 1996, hoje na versão COBIT 2019.',
                example: 'Bancos e grandes empresas usam COBIT para garantir que decisões de TI estejam conectadas aos objetivos do negócio e auditáveis por reguladores.',
              },
              {
                id: 'iso38500',
                term: 'ISO/IEC 38500',
                definition: 'Norma internacional para governança corporativa de TI publicada em 2008 e revisada em 2015. Foca em três princípios: Avaliar o uso atual e futuro, Direcionar planos e políticas, Monitorar conformidade.',
                example: 'É a referência usada por conselhos de administração para discutir TI sem precisar entender tecnicamente — fala a língua do negócio.',
              },
              {
                id: 'itil',
                term: 'ITIL 4',
                definition: 'Information Technology Infrastructure Library. Conjunto de práticas para gerenciamento de serviços de TI, focado em operação. A versão 4 (2019) integra IA, cloud e métodos ágeis.',
                example: 'Quando uma empresa estrutura um service desk, define SLAs internos e padroniza atendimento de incidentes, está usando ITIL.',
              },
            ],
            quotes: [
              {
                ...
                year: 2003,
                source: 'IT Doesn\'t Matter, Harvard Business Review',
                challenge: 'Carr disse que TI virou commodity em 2003. Em 2025, com IA generativa e dados como ativo principal, ele estaria certo? Por quê?',
              },
            ],
            pauses: [
              {
                id: 'fase-empresa',
                question: 'Em qual fase a sua empresa (ou a empresa onde você trabalha) opera hoje? E em qual fase o mercado ao redor já chegou?',
                hint: 'Pense em: como a tecnologia é tratada (custo ou estratégia?), como decisões são tomadas (intuição ou dados?), e o que aconteceria se um concorrente nativo digital entrasse no seu setor amanhã.',
                expectedKeywords: ['fase', 'gap', 'concorrente', 'estratégia', 'dados'],
              },
              {
                id: 'pilar-fraco',
                question: 'Olhando os 4 pilares da governança digital (Estratégia, Riscos/Segurança, Políticas, Monitoramento) — qual deles é o MAIS FRACO na sua empresa hoje? Por quê?',
                hint: 'O pilar mais fraco define a resistência da estrutura inteira. Pensar nele como ponto de partida prático — não como ponto de orgulho.',
                expectedKeywords: ['pilar', 'fraco', 'risco', 'cultura', 'política'],
              },
              {
                id: 'proximos-12-meses',
                question: 'Considerando as tendências de IA, agentes autônomos e RegTech, qual UMA ação concreta sua empresa deveria tomar nos próximos 12 meses? Justifique.',
                hint: 'Resposta forte tem 3 elementos: a ação específica (não "usar mais IA"), o problema que ela resolve, e o resultado mensurável esperado.',
                expectedKeywords: ['ação', 'IA', 'governança', 'observabilidade', 'compliance'],
              },
            ],
            calcs: [
              {
                id: 'custo-composto',
                title: 'Custo composto de não digitalizar',
                inputs: [
                  { id: 'receita', label: 'Receita anual', min: 500000, max: 50000000, default: 5000000, unit: 'R$' },
                  { id: 'perda', label: 'Perda anual por ineficiência', min: 1, max: 15, default: 5, unit: '%' },
                  { id: 'crescimento', label: 'Crescimento do mercado digital', min: 5, max: 30, default: 12, unit: '%/ano' },
                  { id: 'anos', label: 'Anos sem digitalizar', min: 1, max: 10, default: 5, unit: 'anos' },
                ],
                formula: 'receita * (Math.pow(1 + crescimento/100, anos) - Math.pow(1 - perda/100, anos))',
                resultLabel: 'Gap acumulado em relação ao mercado',
            ...
            anims: [
              {
                ...
                data: {
                  phases: [
                    { period: '2000s', label: 'Infraestrutura', desc: 'TI como custo. Foco: uptime, redes, servidores. Banco do Brasil R$ 2bi para conectar 5.000 agências.' },
                    { period: '2010s', label: 'Processo', desc: 'TI como eficiência. ERPs/CRMs integram operação. Magazine Luiza transforma lojas em mini-CDs.' },
                    { period: '2020s', label: 'Estratégia', desc: 'TI como o próprio negócio. Dados e algoritmos viram vantagem. iFood: R$ 100B GMV sem cozinhas.' },
                  ],
                },
              },
            ],
          },
          {
            ...
            type: 'author-card',
            name: 'Nicholas Carr',
            role: 'Escritor e pesquisador de tecnologia',
            affiliation: 'Harvard Business Review / Yale University',
            years: '1959–presente',
            keyStudy: '"IT Doesn\'t Matter" — argumentou que TI se tornou commodity incapaz de gerar vantagem competitiva sustentável. Provocou repensar global sobre investimento em TI.',
            keyYear: 2003,
            contribution: 'Empresas perceberam que tecnologia sem estratégia é custo, não diferencial. Sua tese foi parcialmente correta para a Fase 1 (infraestrutura), mas espetacularmente errada para a Fase 3 (estratégia digital).',
            book: 'Does IT Matter? (2004); The Shallows (2010); The Glass Cage (2014)',
            quote: 'When a resource becomes essential to competition but inconsequential to strategy, the risks it creates become more important than the advantages it provides.',
          },
          {
            id: 'M1-0-ac-brynjolfsson',
            type: 'author-card',
            name: 'Erik Brynjolfsson',
            role: 'Economista digital',
            affiliation: 'Stanford Digital Economy Lab / MIT Sloan',
            years: '1962–presente',
            keyStudy: 'Resolveu o Paradoxo de Solow: demonstrou que ganhos de TI requerem investimentos complementares 5-10x maiores em reorganização organizacional, levando 5-7 anos para se manifestar.',
            keyYear: 2003,
            contribution: 'Provou que produtividade da TI depende de transformação organizacional complementar — não basta comprar o software. Cunhou o conceito de "segunda era das máquinas".',
            book: 'The Second Machine Age (2014); Machine, Platform, Crowd (2017)',
            quote: 'The key insight is that digital technologies do their most transformative work in combination with complementary investments in organizational capital.',
          },
          {
            id: 'M1-0-ac-westerman',
            type: 'author-card',
            name: 'George Westerman',
            role: 'Pesquisador de transformação digital',
            affiliation: 'MIT Sloan / MIT Initiative on the Digital Economy',
            years: 'Ativo desde ~2000',
            keyStudy: 'Pesquisa com 391 empresas em 30 países criou o framework Beginners/Conservatives/Fashionistas/Digirati. Apenas Digirati superam consistentemente: 26% mais lucrativos, 9% maior receita.',
            keyYear: 2014,
            contribution: 'Criou o framework de maturidade digital mais aplicado globalmente. Demonstrou que liderança digital importa tanto quanto capacidade tecnológica — tecnologia sem governança vira "Fashionista".',
            book: 'Leading Digital: Turning Technology into Business Transformation (2014)',
            quote: 'Digital transformation is not about technology — it is about strategy and new ways of thinking.',
          },
          {
            id: 'M1-0-ac-solow',
            type: 'author-card',
            name: 'Robert Solow',
            role: 'Economista — modelo de crescimento econômico',
            affiliation: 'MIT — Prêmio Nobel de Economia 1987',
            years: '1924–2023',
            keyStudy: 'Paradoxo de Solow (1987): observou que computadores estavam por toda parte, menos nas estatísticas de produtividade. Forçou duas décadas de pesquisa econômica para resolver.',
            keyYear: 1987,
            contribution: 'Identificou o paradoxo central da economia digital: investimento massivo em TI sem ganhos mensuráveis de produtividade. Resposta veio de Brynjolfsson: faltavam investimentos complementares em reorganização.',
            book: 'Growth Theory: An Exposition (1970)',
            quote: 'You can see the computer age everywhere but in the productivity statistics.',
          },
          {
            id: 'M1-0-tl1',
            type: 'timeline',
            title: 'Evolução da Tecnologia nos Negócios (2000–2025)',
            events: [
              { year: 2000, title: 'Bolha .com estoura', description: 'Nasdaq perde 78%. Investidores fogem de tecnologia. Sobreviventes (Amazon, Google) emergem mais fortes da poeira.', milestone: true },
              { year: 2003, title: 'Carr publica "IT Doesn\'t Matter" na HBR', description: 'Harvard Business Review. TI vista como commodity. Debate global sobre investimento em tecnologia. Microsoft reage publicamente.', milestone: true },
              { year: 2005, title: 'Banco do Brasil conclui interligação digital', description: 'R$ 2 bilhões investidos. 5.000 agências conectadas. Foco: uptime e SLA. TI = custo operacional puro.' },
              { year: 2007, title: 'iPhone lançado', description: 'Início da era mobile. Em 5 anos, smartphones superam PCs em acessos à internet no Brasil. Reconfigura toda a relação cliente-empresa.', milestone: true },
              { year: 2010, title: 'Onda de ERPs no Brasil', description: 'SAP, Oracle e TOTVS dominam o mercado brasileiro. Empresas correm para integrar operações fragmentadas em sistemas únicos.' },
              { year: 2012, title: 'Natura implementa SAP global', description: '7 países integrados. Projeção de R$ 500M em economia em 5 anos. Planilhas viram dashboards em tempo real.' },
              { year: 2013, title: 'Nubank fundado', description: 'David Vélez funda o Nubank em apartamento em SP. Proposta: banco 100% digital, sem agência, sem tarifa. CAC: fração do bancário tradicional.' },
              { year: 2014, title: 'Brynjolfsson & McAfee publicam "The Second Machine Age"', description: 'MIT. Tese: máquinas substituindo força cognitiva humana. Dados e algoritmos como novo capital competitivo.', milestone: true },
              { year: 2015, title: 'Trajano assume Magazine Luiza', description: 'Início da transformação digital mais emblemática do varejo BR. Lojas viram mini-CDs. Marketplace + super-app.' },
              { year: 2016, title: '"Platform Revolution" publicado', description: 'Parker, Van Alstyne & Choudary teorizam economia de plataformas. Efeitos de rede como moat competitivo central.' },
              { year: 2020, title: 'Pandemia acelera digitalização', description: 'COVID-19 comprime 5 anos de transformação digital em 5 meses. E-commerce BR cresce 73% (ABComm). Empresas analógicas quebram.', milestone: true },
              { year: 2022, title: 'ChatGPT lançado pela OpenAI', description: 'IA generativa democratizada. 100 milhões de usuários em 2 meses — produto de crescimento mais rápido da história.', milestone: true },
              { year: 2023, title: 'iFood atinge R$ 100B GMV', description: 'Plataforma movimenta R$ 100 bilhões/ano. Zero cozinhas próprias. 80M pedidos/mês. 100% data-driven.' },
              { year: 2023, title: 'Nubank: 80M+ clientes', description: 'Maior banco digital do mundo fora da China. Listado na NYSE. Prova que modelo digital escala exponencialmente.' },
              { year: 2025, title: 'IA agente e automação cognitiva', description: 'Agentes de IA começam a executar tarefas complexas autonomamente. Empresas sem IA perdem competitividade aceleradamente.', milestone: true },
            ],
          },
